...
//         // Enter fullscreen after slight delay
//         setTimeout(() => {
...
//     // Check fullscreen state immediately when the component loads
//     checkFullscreen();
...
//   return (
//     <div ref={examContainerRef} className="container mx-auto p-4 bg-white relative">
...
//new code also full screen button on the warnong panel:
...
//       // Open certificate in new tab if it exists
//       if (certificateUrl) {
